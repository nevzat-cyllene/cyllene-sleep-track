  ...
  if (compact) {
    return (
      <div className="space-y-3 sm:space-y-4">
        <div className="relative overflow-hidden rounded-[1.55rem] border border-[#8dbdff]/20 bg-[linear-gradient(135deg,rgba(35,92,168,.42)_0%,rgba(21,96,255,.25)_38%,rgba(12,31,73,.88)_100%)] p-4 shadow-[0_30px_100px_rgba(28,105,255,.24),inset_0_1px_0_rgba(255,255,255,.09)] sm:rounded-[1.8rem] sm:p-8">
          ...
          <div className="relative grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center sm:gap-7">
            <div>
              <div className="mb-3 flex items-center gap-2 text-[11px] text-[#8bbdff] sm:mb-4 sm:text-xs">
              ...
              <h2 className="max-w-md text-balance text-[1.65rem] font-medium leading-[1.02] tracking-[-0.045em] sm:text-4xl">
            ...
            <Button
              ...
              onClick={onStart}
              disabled={isLoading}
              className="h-12 w-full rounded-2xl bg-[linear-gradient(135deg,#8fd1ff_0%,#2d79ff_42%,#165dff_100%)] px-6 text-sm font-semibold text-white shadow-[0_18px_50px_rgba(24,105,255,.38),inset_0_1px_0_rgba(255,255,255,.18)] transition duration-150 hover:brightness-110 active:scale-[0.98] sm:h-14 sm:w-auto sm:px-7 sm:text-base"
            >
        ...
        <RecordingGuidanceBanner
          mode="setup"
          className="hidden rounded-2xl border-white/[0.07] bg-white/[0.025] text-xs sm:block"
        />
      </div>
    );
  }
